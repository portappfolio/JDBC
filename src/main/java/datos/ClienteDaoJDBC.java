...
public class ClienteDaoJDBC {
    ...
    public Cliente encontrar(Cliente cliente){
        ...
        try {
            ...
            stmt.setInt(1, cliente.getIdCliente()); //setea el parametro que se define arriba en los private static final cón ?, se setea porque es de tipo entero y se menciona el indice del ? que se quiere modificar
            rs = stmt.executeQuery();
